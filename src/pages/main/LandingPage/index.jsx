...
const LandingPage = () => {
  return (
    <>
      ...
      <TestimonialCard />
      <section className="container flex overflow-hidden relative flex-col self-center pt-14 pb-2.5 mt-10 mb-20 w-full fill-white fill-opacity-10 max-w-[1140px] min-h-[294px] max-md:mt-10 max-md:max-w-full">
